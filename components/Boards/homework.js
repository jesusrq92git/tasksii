...
const Homework = props => {
  ...
  const { items, handleView, handleEdit, handleRemove, LoginReducer } = props;
          ...
          <Row>
            <Col>
              <div className={"pos-btn-board"}>
                ...
                <p className={"btn-board"} onClick={() => handleView(item)}>
                ...
                <p className={"btn-board"} onClick={() => handleEdit(item)}>
                ...
                <p className={"btn-board"} onClick={() => handleRemove(item)}>
